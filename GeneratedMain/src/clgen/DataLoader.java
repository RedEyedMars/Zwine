...
public class DataLoader extends ExternalClassEntry {
	...
	public void __INIT__(){
		...
		public void get(StringBuilder builder){
			...
			new StringEntry("DataLoader").get(builder);
			new StringEntry("").get(builder);
		}
	},
			Arrays.asList(new ExternalVariableEntry[]{new ExternalVariableEntry(false, /*TypeName*/new ExternalStatement.TypeName(/*TypeName*/new ExternalStatement.TypeName(new StringEntry("ObjectInputStream"))),"", /*Name*/new ExternalStatement(new StringEntry("stream")), /*Name*/new ExternalStatement(/*Acss*/new ExternalStatement(/*Name*/new ExternalStatement(new StringEntry("null")))))}), 
...
/*BODY*/				
	/*Cond*/new ExternalStatement.Conditional(
			...
			/*Body*/new ExternalStatement.Body(
	/*Elem*/new ExternalStatement(new TabEntry(new StringEntry("")), new StringEntry(";"), /*Exac*/new ExternalStatement(new StringEntry("e0.printStackTrace()"))))))),new ExternalMethodEntry(0, false,/*TypeName*/new ExternalStatement.TypeName(/*TypeName*/new ExternalStatement.TypeName(new StringEntry("Boolean"))),"", /*Exac*/new ExternalStatement(new StringEntry("readAsBoolean")), /*Parameters*/Arrays.asList(new ExternalVariableEntry[]{}), "throws IOException", /*Body*/new ExternalStatement.Body(
